...
func (m *metricsMiddleware) ProxyRequest(ctx context.Context, session *cubeauth.Session, path string) (err error) {
...
func (m *metricsMiddleware) GetAttestationPolicy(ctx context.Context, session *cubeauth.Session) ([]byte, error) {
	return m.svc.GetAttestationPolicy(ctx, session)
}

// UpdateAttestationPolicy implements proxy.Service.
func (m *metricsMiddleware) UpdateAttestationPolicy(ctx context.Context, session *cubeauth.Session, policy []byte) error {
...
func (m *metricsMiddleware) DeleteRoute(ctx context.Context, session *cubeauth.Session, name string) (err error) {
	defer func(begin time.Time) {
