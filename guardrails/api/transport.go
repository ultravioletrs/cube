...
func MakeHandler(svc guardrails.Service, instanceID string) http.Handler {
	...
	// Chat completion endpoint for OpenAI-compatible API
	...
	// Flow Management
	mux.Route("/api/v1/flows", func(r chi.Router) {
	...
	mux.Route("/api/v1/kb", func(r chi.Router) {
...
func decodeChatCompletionRequest(_ context.Context, r *http.Request) (interface{}, error) {
	...
	if userID == "" {
		userID = r.Header.Get("Authorization") // Could extract from JWT
	}
